...
namespace laba2
{
    ...
    /// <summary>
    /// ViewModel приложения. Отвечает только за:
    /// 1) диалог выбора файла;
    /// 2) загрузку BitmapImage и выгрузку пикселей в byte[];
    /// 3) вызов Core-сервисов;
    /// 4) упаковку результатов в BitmapImage для отображения.
    /// </summary>
